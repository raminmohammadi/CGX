...
const tabs = [
  { to: "/settings", label: "⚙️ Profiles & Setup", icon: Settings, pageKey: null },
  ...
  { to: "/plan", label: "🛠️ Self-Testing Plan", icon: Wand2, pageKey: "plan" as const },
  ...
  return (
    ...
    >
      <div className="p-3 space-y-5 overflow-y-auto">
        <div>
          <div className="av-section-eyebrow px-2 mb-2">Engine Core Layers</div>
